...
let Areas = class Areas extends repository_1.Entity {
    constructor(data) {
        super(data);
    }
};
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Number)
], Areas.prototype, "idPlanta", void 0);
tslib_1.__decorate([
    repository_1.property({
        type: 'string',
        required: true,
...
], Areas.prototype, "descr", void 0);
Areas = tslib_1.__decorate([
    repository_1.model({ settings: { idInjection: false, postgresql: { schema: 'public', table: 'areas' } } }),
